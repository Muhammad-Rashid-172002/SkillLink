...
class WorkerChatDetailScreen extends StatefulWidget {
  ...
  @override
  State<WorkerChatDetailScreen> createState() =>
      _WorkerChatDetailScreenState();
}
...
class _WorkerChatDetailScreenState extends State<WorkerChatDetailScreen>
  ...
  DocumentReference<Map<String, dynamic>> get _customerRef =>
  ...
  Future<void> _sendMessage(Map<String, dynamic> content) async {
    ...
    try {
      ...
      batch.set(_chatRef, {
        'participants': [_currentUserId, widget.customerId],
        'lastMessage': preview,
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              width: 270,
              decoration: BoxDecoration(
                color: const Color(0xFF14B8A6).withOpacity(.035),
                shape: BoxShape.circle,
              ),
            ),
          ),
                    ...
                    StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                      ...
                      builder: (context, chatSnapshot) {
                        ...
                        final customerTyping =
                            typingMap?[widget.customerId] == true;
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          ...
                          const Color(0xFF14B8A6).withOpacity(.08),
                        ],
                      ),
                      borderRadius: BorderRadius.circular(26),
                    ),
                  ...
                  const SizedBox(height: 7),
                  Text(
                    'Send a message to ${widget.customerName} about ${widget.service}.',
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      color: Color(0xFF64748B),
                      fontSize: 11,
  ...
  Widget _buildAudioPlayer(
    ...
    final duration =
        _audioDurations[messageId] ?? Duration.zero;
  ...
  Widget _buildTypingIndicator() {
    return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        final typing =
            snapshot.data?.data()?['typing'] as Map?;
        final isCustomerTyping =
            typing?[widget.customerId] == true;
              ...
              children: [
                Text(
                  data['senderId'] == _currentUserId
                      ...
                      : 'Replying to ${widget.customerName}',
                  style: const TextStyle(
                    color: primary,
                    fontSize: 10.3,
                    fontWeight: FontWeight.w900,
  ...
  String _lastSeenText(dynamic value) {
    if (value is! Timestamp) return widget.service;
