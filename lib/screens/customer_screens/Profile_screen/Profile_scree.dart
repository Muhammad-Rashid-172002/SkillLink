...
class _CustomerProfileScreenState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar:
          const CustomerBottomBar(selectedIndex: 4),
      body: Stack(
        children: [
          Positioned(
            top: -150,
                          ...
                          delegate: SliverChildListDelegate(
                            [
                              ...
                              _sectionTitle(
                                title: 'Preferences',
                                subtitle:
                                    'Control notifications and app settings',
                              ),
                              const SizedBox(height: 12),
                              _preferencesMenu(),
                              const SizedBox(height: 20),
                              _sectionTitle(
                                title: 'Support & legal',
                                subtitle:
                                    'Get help and review app policies',
                              ),
                              const SizedBox(height: 12),
                              _supportMenu(),
                              const SizedBox(height: 20),
  ...
  Widget _profileHero(
    ...
    final name =
        _fallback(user['name'], 'Customer');
    final phone =
        _fallback(user['phone'], 'Phone unavailable');
    final city =
        _fallback(user['city'], 'City unavailable');
    final area =
        _fallback(user['area'], '');
...
Widget _accountStats(
  ...
  return FutureBuilder<QuerySnapshot>(
    ...
    builder: (context, snapshot) {
      ...
      final saved =
          _intValue(user["savedWorkersCount"]);
    ...
    return _menuContainer(
      children: [
        ...
        _profileTile(
          ...
          onTap: () {
            _showMessage(
              'My Requests screen can be connected here.',
            );
          },
        ),
        _divider(),
        _profileTile(
          ...
          title: 'Saved workers',
          subtitle:
              'View professionals you saved',
          color: _danger,
          onTap: () {
            _showMessage(
              'Saved Workers screen can be connected here.',
            );
          },
        ),
      ],
    ...
    return _menuContainer(
      children: [
        _profileTile(
          ...
          onTap: () {
            _showMessage(
              'Notifications screen can be connected here.',
            );
          },
        ),
        _divider(),
        _profileTile(
          ...
          title: 'Settings',
          subtitle:
              'App, security and account preferences',
          color: _textSecondary,
          onTap: () {
            _showMessage(
    ...
    return _menuContainer(
      children: [
        _profileTile(
          ...
          onTap: () {
            _showMessage(
              'Help & Support screen can be connected here.',
            );
          },
        ),
        _divider(),
        _profileTile(
          ...
          onTap: () {
            _showMessage(
              'Privacy Policy screen can be connected here.',
            );
          },
        ),
        _divider(),
        _profileTile(
          ...
          subtitle:
              'Version, company and app information',
          color: _secondary,
          badge: 'v1.0',
          onTap: () {
            _showMessage(
              'About SkillLink screen can be connected here.',
            );
          },
        ),
      ],
